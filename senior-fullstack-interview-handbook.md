...
<p class="handbook-version" data-version="v1.2.3">Версия <code>v1.2.3</code></p>
...
**Для чего используется** — даёт измеримый сигнал о качестве или поведении системы, по которому можно выбрать приоритет улучшений.
...
**Для чего используется** — даёт диагностический сигнал по теме «LCP — Largest Contentful Paint»: помогает заметить проблему, локализовать её причину и выбрать проверку или защиту.
...
**Для чего используется** — даёт диагностический сигнал по теме «CLS — Cumulative Layout Shift»: помогает заметить проблему, локализовать её причину и выбрать проверку или защиту.
...
**Для чего используется** — даёт диагностический сигнал по теме «INP — Interaction to Next Paint»: помогает заметить проблему, локализовать её причину и выбрать проверку или защиту.
...
**Для чего используется** — даёт диагностический сигнал по теме «Observability»: помогает заметить проблему, локализовать её причину и выбрать проверку или защиту.
...
**Для чего используется** — даёт диагностический сигнал по теме «SLI, SLO, SLA — Service Level Indicator, Objective, Agreement»: помогает заметить проблему, локализовать её причину и выбрать проверку или защиту.
...
**Для чего используется** — даёт диагностический сигнал по теме «Incident response»: помогает заметить проблему, локализовать её причину и выбрать проверку или защиту.
